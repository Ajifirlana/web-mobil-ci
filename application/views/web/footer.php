...
<!-- Clients starts -->
  ...
  <!--div class="clients">
    <div class="container">
            <div class="row">
               <div class="col-md-12">
                     <h3 class="title">Klien Kami</h3>
                     <p><i class="fa fa-quote-left lightblue"></i>Terimakasih.<i class="fa fa-quote-right lightblue"></i></p>
                     <img src="img/clients/amazon.png" alt="" class="img-responsive" />
                     <img src="img/clients/google.png" alt="" class="img-responsive" />
                     <img src="img/clients/twitter.png" alt="" class="img-responsive" />
                     <img src="img/clients/facebook.png" alt="" class="img-responsive" />
                     <img src="img/clients/skype.png" alt="" class="img-responsive" />
                     <img src="img/clients/youtube.png" alt="" class="img-responsive" />
               </div>
            </div>
    </div>
  </div>
  ...
  <div class="container">
			...
			<form class="form-inline" role="form">
              ...
              <div class="social">
                ...
                <?php if ($data_web->twitter != ''): ?>
                        <a href="<?php echo $data_web->twitter; ?>" class="blightblue" target="_blank"><i class="fa fa-instagram"></i></a>
                <?php endif; ?>
	...
	<div class="row">
      <div class="col-md-12">
          <div class="copy">
                <p>
                  Copyright &copy; <a href="http://caramengatasimasalahmu.blogspot.com/"><?php echo substr(base_url(), 7); ?></a> - <a href="<?php echo base_url(); ?>">Home</a>
...
<!-- Mirrored from ashobiz.dreamhosters.com/wrapbootstrap/metroman325/index-parallax.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Sep 2020 08:40:16 GMT -->
</html>
